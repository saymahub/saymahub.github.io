...
export const Footer = ({ isMenuOpen, setIsMenuOpen }: FooterProps) => {
    ...
    return (
        <nav className={cn("fixed w-full md:bg-[color:var(--background)] bg-[color:var(--background)]/0 bottom-0 left-1/2 transform -translate-x-1/2 z-40 transition-all duration-300", 
            ...
            <div className="container mx-auto flex items-center py-4 justify-center">
                ...
                {/* mobile nav */}
                <div className={cn("fixed inset-0 opacity-0 z-40 flex flex-col items-center justify-center transition-all duration-30 md:hidden",
