...
export const Credits = () => {
    ...
    const revealSecret2 = () => {
        setRevealed2(true);
        setTimeout(() => setRevealed2(false), 3000);
    };
        ...
        <section id="credits" className="md:snap-start md:h-screen relative min-h-screen flex items-center justify-center bottom-45 z-10 pt-0 md:pt-10 translate-y-[20px]">
            <div className="relative container max-w-4xl mx-auto text-center z-10 ">
                <h2 className="text-3xl md:text-5xl text-glow mb-12">
                    ...
                    <button onClick={revealSecret2}> 
                            <span className="text-[10px] md:text-[30px]">⋆⋆⋆</span>
                    </button>
                    {revealed2 && (
                        <span className="absolute left-1/2 transform -translate-x-1/2 translate-y-[30px] md:translate-y-[50px] mt-1 text-[20px] text-primary bg-[color:var(--primary)]/10 px-2 py-1 rounded">
                            Khalil Taylor I've sent a bomb to ur residence
                        </span>
                    )}
                </h2>
